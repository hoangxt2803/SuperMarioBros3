...
#define MARIO_SIT_HEIGHT_ADJUST_BIG ((MARIO_BIG_BBOX_HEIGHT-MARIO_BIG_SITTING_BBOX_HEIGHT)/2)
#define MARIO_SIT_HEIGHT_ADJUST_RACCON ((MARIO_RACCON_BBOX_HEIGHT-MARIO_BIG_SITTING_BBOX_HEIGHT)/2)
